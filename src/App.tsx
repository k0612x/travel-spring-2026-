...
const DestinationComparison = () => {
  ...
  const ComparisonCard = ({ destination }) => (
    <div 
            ...
            <div className="p-6 space-y-6 max-h-[70vh] overflow-y-auto">
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-2">
                  {selectedDestination.attractions.map((item, idx) => (
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-2">
                  {selectedDestination.food.map((item, idx) => (
                    <div key={idx} className="px-3 py-2 bg-gray-50 rounded-lg text-sm">
                      {item}
                    </div>
                  ))}
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <ul className="space-y-2">
                    {selectedDestination.pros.map((item, idx) => (
                ...
                <div>
                  ...
                  <ul className="space-y-2">
                    {selectedDestination.cons.map((item, idx) => (
                      <li key={idx} className="text-sm flex items-start gap-2">
